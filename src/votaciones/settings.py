...
UCO_CLIENT_ID = env("UCO_CLIENT_ID")
UCO_SECRET_ID = env("UCO_SECRET_ID")
UCO_AUTHORIZATION_URL = env("UCO_AUTHORIZATION_URL")
UCO_TOKEN_URL = env('UCO_TOKEN_URL')
UCO_USER_INFO = env("UCO_USER_INFO")
